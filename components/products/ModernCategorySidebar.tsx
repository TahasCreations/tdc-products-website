...
export default function ModernCategorySidebar({
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <motion.button
                ...
                className="hidden lg:block p-2 rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
              >
  ...
  const MobileFilterButton = () => (
    <motion.button
      ...
      className="lg:hidden fixed bottom-6 left-6 z-40 w-14 h-14 rounded-full bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white shadow-2xl flex items-center justify-center"
    >
      <SlidersHorizontal className="w-6 h-6" />
      {hasActiveFilters && (
        <span className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 rounded-full border-2 border-white flex items-center justify-center text-xs font-bold">
          !
        </span>
      )}
    </motion.button>
        ...
        <div className="h-full backdrop-blur-2xl bg-white/80 dark:bg-gray-900/80 border-r border-gray-200/50 dark:border-gray-700/50 shadow-2xl">
          <div className="flex flex-col items-center p-4 space-y-6">
            ...
            <div className="flex flex-col space-y-4">
              <motion.div 
                whileHover={{ scale: 1.1 }}
                className="p-2 rounded-xl bg-indigo-50 dark:bg-indigo-900/30 cursor-pointer"
                title="Kategoriler"
              >
              ...
              <motion.div 
                whileHover={{ scale: 1.1 }}
                className="p-2 rounded-xl bg-emerald-50 dark:bg-emerald-900/30 cursor-pointer"
              ...
              <motion.div 
                whileHover={{ scale: 1.1 }}
                className="p-2 rounded-xl bg-amber-50 dark:bg-amber-900/30 cursor-pointer"
                title="Stok Durumu"
              >
