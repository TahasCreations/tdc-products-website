...
const navigationGroups = [
  ...
  },
  {
    ...
    color: 'purple',
    items: [
      { name: 'Siparişler', href: '/admin/commerce/orders', icon: Package, badge: '1.2K' },
      ...
      { name: 'Satıcılar', href: '/admin/commerce/sellers', icon: Store, badge: '89' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Kuponlar', href: '/admin/marketing/coupons', icon: Ticket, badge: '45' },
