          ...
          >
            ...
            >
              <div className="relative">
                ...
                <button
                  type="submit"
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-indigo-500 text-white rounded-xl flex items-center justify-center hover:bg-indigo-600 transition-colors"
                >
            ...
            >
              <motion.button
                ...
                className="group relative px-8 py-4 bg-gradient-to-r from-indigo-500 to-coral-500 text-white rounded-2xl font-semibold text-lg shadow-2xl hover:shadow-indigo-500/25 transition-all duration-300"
              >
              ...
              <motion.button
                ...
                className="group relative px-8 py-4 border-2 border-ink-300 text-ink-700 rounded-2xl font-semibold text-lg hover:border-indigo-400 hover:text-indigo-600 transition-all duration-300 bg-white/50 backdrop-blur-sm"
              >
          ...
          >
            <div className="relative w-full h-96 lg:h-[500px]">
              ...
              <motion.div
                ...
                className="absolute top-10 right-10 w-16 h-16 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg flex items-center justify-center"
              >
              ...
              <motion.div
                ...
                className="absolute bottom-20 left-10 w-20 h-20 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg flex items-center justify-center"
              >
                <svg className="w-10 h-10 text-coral-500" fill="currentColor" viewBox="0 0 24 24">
              ...
              <motion.div
                ...
                className="absolute top-1/2 left-5 w-12 h-12 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg flex items-center justify-center"
              >
