        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">TDC Market</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Türkiye'nin en büyük 3D figür ve dekoratif obje pazarı. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/stores" className="text-gray-300 hover:text-white transition-colors">Mağazalar</Link></li>
              <li><Link href="/new" className="text-gray-300 hover:text-white transition-colors">Yeni Ürünler</Link></li>
              <li><Link href="/trending" className="text-gray-300 hover:text-white transition-colors">Trend Ürünler</Link></li>
              <li><Link href="/sale" className="text-gray-300 hover:text-white transition-colors">İndirimli Ürünler</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/faq" className="text-gray-300 hover:text-white transition-colors">Sık Sorulan Sorular</Link></li>
            </ul>
          </div>
        </div>
