      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">İzmir Bornova&apos;daki ofisimizi ziyaret edebilirsiniz.</p>
          </div>
          <div className="bg-white p-4 rounded-xl shadow-sm">
            <div className="aspect-video w-full bg-gray-200 rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">Erzene, 66. Sk. No:5 D:1A, 35040 Bornova/İzmir</p>
              </div>
            </div>
          </div>
        </div>
